dev.up:
	docker-compose -f docker/docker-compose.yml -f docker/docker-compose.dev.yml up -d --scale php=2
...
prod.up:
	docker-compose -f docker/docker-compose.yml up -d --scale php=3
