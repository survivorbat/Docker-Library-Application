 ...
 */
final class Version20190301214710 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employee (id VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, insertion VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE book_exemplar (id VARCHAR(255) NOT NULL, past_loans_id VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_EAD50C98CC640AAD (past_loans_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE book_exemplar ADD CONSTRAINT FK_EAD50C98CC640AAD FOREIGN KEY (past_loans_id) REFERENCES book_loan (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book_exemplar DROP FOREIGN KEY FK_EAD50C98CC640AAD');
